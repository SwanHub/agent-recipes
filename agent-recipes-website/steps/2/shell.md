...
Shared chrome every page wears. Warm minimal canvas, Geist, single orange accent, dark mode. Brand: **Agent Recipes Website**. **Catalog only — no auth, no "join" concept.**
...
7. `app/layout.tsx` — Geist, metadata titled **Agent Recipes Website**, header + footer wrap children.
