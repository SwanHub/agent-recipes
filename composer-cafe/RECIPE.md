...
| 3   | `steps/3/` | People **(write)** — persistence, data layer, UI (3 parallel)                         | files compile  |
| 4   | `steps/4/` | People **(ship)** — migrate, seed users, verify profiles                               | **USER PAUSE** |
| 5   | `steps/5/` | Skills **(write)** — schema, data layer, pack browser, UI, profile skills, seed       | files compile  |
| 6   | `steps/6/` | Skills **(ship)** — migrate, seed skills, verify `/skills` + profile skills           | **USER PAUSE** |
| 7   | `steps/7/` | Recipes **(write)** — schema, data layer, UI, profile recipes, seed recipes           | files compile  |
